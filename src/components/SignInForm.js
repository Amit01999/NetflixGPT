...
const SignInform = () => {
  ...
  const [emailPhone, setEmailPhone] = useState('user1@gmail.com');
  const [password, setPassword] = useState('User@11111');
      ...
      <div className="w-full">
        ...
        <div className="mb-2 text-white">
          <input
            ...
            className={`px-4 py-4 w-full text-white bg-[#333] border-b-2 rounded-[4px] focus:bg-[#4d4c4c] focus-visible:outline-none text-sm ${
        ...
        <form onSubmit={e => e.preventDefault()}>
          ...
          <div className="my-2">
            <button
              ...
              className="flex items-center justify-center px-4 py-3 mt-4 bg-red-primary text-white w-full rounded-[4px] disabled:bg-red-800"
            >
              {loadingBtn ? (
